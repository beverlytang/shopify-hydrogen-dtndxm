...
import {FeaturedCollections, HeroLazy} from '~/components';
...
function HomepageContent() {
  ...
  return (
    <>
      {primaryHero && (
        <Suspense>
          <HeroLazy {...primaryHero} height="full" top loading="eager" />
        </Suspense>
      )}
      <ProductSwimlane
        ...
        divider="bottom"
      />
      {secondaryHero && <HeroLazy {...secondaryHero} />}
      <FeaturedCollections
        data={featuredCollections.nodes}
        title="Collections"
      />
      {tertiaryHero && <HeroLazy {...tertiaryHero} />}
    </>
  );
}
